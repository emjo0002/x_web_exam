...
google_spread_sheet_key = "1bsyi0kNvua1HhLZAKHnFVh8pdf_WXHqH3U79ZpGScc4"
...
def send_email(to_email, subject, template):
    try:
        ...
        sender_email = "emil.johansson@gmail.com"
        password = "qbhf hhvo kyid lqwg"  # If 2FA is on, use an App Password instead
